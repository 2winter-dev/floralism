        ...
        <div style={{backgroundColor: 'rgb(240,240,240)'}}>
            ...
            <div className={styles.totalLayout} style={{ backgroundColor: 'rgb(240,240,240)' }}>
                <div style={{ backgroundColor: 'white', padding: 16, borderRadius: 8 }}>
                    ...
                    <br></br>
                    <div>若收件者與購買者並非同一人，下單時必須同時提供收件者及購買者之姓名及聯絡電話。Léselle 會確保客戶所提供的任何資料不會透露予收件方。</div>
                    ...
                    <br />
                    <div style={{}}>如送貨當天需臨時更改地址、時間或日期，Léselle 將按個別情況作出適當安排。若更改後之地址或時間未能配合司機當天之送貨路線，有關訂單將會被安排於該司機當天所派送之全部訂單完成後送出；若更改後之地址或時間仍能配合司機當天之送貨路線，有關訂單將會如常送出。</div>
                    <br />
                    <br />
                    <div style={{ fontSize: 20, fontWeight: 400 }}>特別狀況處理</div>
                    <div style={{ marginTop: 12 }}>如遇路面擠塞、交通意外、特別天氣狀況等，導致訂單有機會未能按時送出，Léselle 會立刻聯絡客人告知相關狀況，請求指示，以作出適當安排及處理。</div>
                    <br />
                    <br />
                    ...
                    <div style={{ marginTop: 12 }}>若收件方拒收貨品，而有關貨品被退回至本公司，Léselle 會等待客戶下一步指示。若三個月內仍未收到任何有關指示，floralism 將當作棄件處理。</div>
                    <br />
                    <br />

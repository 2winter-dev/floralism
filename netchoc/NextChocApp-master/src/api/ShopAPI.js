...
export default ShopApi = {
    ...
    describeShop:async (data)=>await ST_request({method:'POST',data,path:`/api/merchant/subscription`}),
    undescribe:async (data)=>await ST_request({method:'POST',data,path:`/api/merchant/unsubscription`}),

...
export default OrderApi = {
    ...
    fetchFinishOrderList:async(data)=>await ST_request({method:"GET",data,path:`/api/order/index?status=3`}),
    fetchOrderList: async (data) => await ST_request({ method: 'GET', data, path: `/api/order/index?status=${data.status}` }),

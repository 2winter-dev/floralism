...
export default function InputAddress() {
    ...
    return (<View style={{ marginTop: 24, width: '100%',marginBottom:18,flex:1 }}>
        <View style={{ width: '100%', paddingVertical: 8, flexDirection: 'row', backgroundColor: 'rgba(242,242,242,0.6)', borderWidth: 1, borderColor: 'rgba(0,0,0,0.2)', borderRadius: 32, paddingHorizontal: 16, display: 'flex', alignItems: 'center' }}>
            <EvilIcons name="location" size={24} color="rgba(0,0,0,0.3)" style={{ marginRight: 12, paddingVertical: 8 }} />
            <TextInput style={{ flex: 1, fontSize: 16 }} placeholder="Enter new addressss" onChangeText={_Input} />
        </View>

        <ScrollView style={{ marginTop: 16, paddingLeft: 16,marginBottom:12 }}>
            {
